...
bool GraphicsClass::Initialize(OpenGLClass* OpenGL, HWND hwnd)
{
	...
	terreno = new Terreno(hwnd, m_OpenGL, L"terreno.jpg", L"Piedras.jpg", L"Piedras_normal.jpg", //Textura1 
		L"Terreno2.jpg", L"Terreno2Normal.jpg", //Textura2
		L"Zacatito.jpg", L"ZacatitoNorm.jpg", //Textura3
		L"MapaColores.png",
		(float)400, (float)400,
		0, 1,
		2, 3,
...
#pragma region Carga de Modelos
	...
	esfingeTest = new Modelos(hwnd, m_OpenGL, "es5.obj", L"esfingeBase.jpg", L"esfingeNorm4.jpg", L"esfingeSpecular.png" , 4.0, 30.0, -0.200, -30.0, 2);
...
#pragma region Terreno
	...
	m_LightShader->Pon1Entero(m_OpenGL, (char*)"shaderTexture3", 2);
	m_LightShader->Pon1Entero(m_OpenGL, (char*)"shaderTexture4", 3);
	m_LightShader->Pon1Entero(m_OpenGL, (char*)"ShaderTextureZacate", 4);
	m_LightShader->Pon1Entero(m_OpenGL, (char*)"ShaderTextureNormZacate", 5);
	//En caso de no jalar entonces, matar durante un rato el blendmap y poner las texturas a mano
